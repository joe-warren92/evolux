export const SERVICES = [
  {
    ...
    trust: [
      ["No hidden costs", "Every web design project is scoped before work starts, with deliverables, timelines and ownership agreed in writing."],
      ["You deal with the designer", "You work directly with Joe from strategy through launch, so nothing gets lost through account managers or briefing chains."],
  ...
  },
  {
    ...
    packages: [
      ["Audit", "£450", "Fixed fee", "A complete conversion audit with video walkthrough.", ["20-point audit", "Analytics review", "Priority action plan", "Video walkthrough"]],
      ["Audit + Build", "£1,200", "Starting from", "Audit plus implementation of the highest-impact fixes.", ["Everything in Audit", "Priority fixes implemented", "CTA/copy improvements", "30-day review"], true]
    ],
    faqs: [
      ["My website is fairly new. Do I still need conversion optimisation?", "Possibly, yes. A new website can still underperform if it was designed around appearance rather than conversion strategy, search intent, trust signals and user behaviour. A CRO audit identifies where visitors hesitate, lose confidence or fail to take the next step. If you want a lighter starting point first, request a <a href=\"/free-review\">free website review</a>."],
      ["How long does a CRO audit take?", "A standard conversion rate optimisation audit is usually delivered within five business days once access and information are received. You get a prioritised action plan and a video walkthrough explaining what is hurting enquiries, what to fix first and which changes are likely to have the biggest commercial impact."],
  ...
  },
  {
    ...
    packages: [
      ["Brand Essentials", "£950", "Starting from", "Logo, colour and typography foundation.", ["Strategy session", "Logo suite", "Colour palette", "Typography system"]],
      ["Brand System", "£1,800", "Starting from", "Complete brand system with guidelines and launch assets.", ["Everything in Essentials", "Guidelines document", "Social media kit", "Launch assets"], true]
    ],
    faqs: [
      ["Do I need a full brand identity or just a logo?", "If your business only needs a simple mark for a very limited use, a logo may be enough. If your brand needs to work across a website, social media, proposals, signage, print and sales materials, you will usually need a fuller identity system: logo, colours, typography, spacing, usage rules and tone. The article on <a href=\"/insights/brand-identity-and-web-design\">brand identity and web design</a> explains why the two should work together."],
      ["What happens before the brand design starts?", "Every brand identity project starts with strategy. Joe looks at your market, audience, competitors, offer, tone of voice and what the brand needs to communicate before visual work begins. This makes the design more commercially useful and avoids choosing colours or logo styles based only on personal taste."],
      ["How many logo concepts will I receive?", "Evolux presents one fully considered brand direction rather than several weaker options. This keeps the project focused on the strongest strategic route and avoids choosing between disconnected logo ideas. The direction includes rationale, usage examples and room for refinement through the included revision rounds."],
      ["How many revisions are included in a branding project?", "Two rounds of revisions are included as standard. Because the strategy session defines audience, positioning, tone and visual direction before design begins, feedback is usually focused and practical. Additional revisions or extended brand assets can be scoped separately if the project grows."],
  ...
  },
  {
    ...
    packages: [
      ["Project-based", "From £250", "Per project", "A clearly scoped design project with fixed deliverables.", ["Social graphics", "Flyers and brochures", "Presentation templates", "Print-ready files"]],
      ["Design Retainer", "£350", "/mo", "Ongoing design support for regular marketing needs.", ["Priority turnaround", "Monthly design time", "Consistent brand output", "Flexible deliverables"], true]
    ],
    faqs: [
      ["Can you create marketing materials if my brand is not very polished yet?", "Yes, but Joe will flag any brand gaps before design work begins. If your logo, colours or fonts are inconsistent, the finished materials may only be able to go so far. In that case, it may be better to tidy the foundations first with <a href=\"/services/branding\">brand identity</a> work, then create the graphic design assets."],
      ["What graphic design file formats will I receive?", "Final files are supplied in the formats needed for the job. Digital assets may include PNG, JPEG, SVG or web-ready exports, while print projects can include print-ready PDFs and source files where agreed. The aim is to give you usable design assets for social media, email, print, presentations and your website."],
      ["How does a monthly design retainer work?", "A retainer gives you a set amount of priority design support each month. You send requests as they arise, such as social graphics, flyers, pitch decks, adverts or campaign assets, and they are handled in priority order. It is ideal for businesses that need regular, consistent marketing design without hiring in-house."],
      ["Can you work to our existing brand guidelines?", "Yes. If you already have brand guidelines, all graphic design work is created within that system so your marketing stays consistent. If the guide is missing important details such as spacing, type hierarchy, colour usage or social templates, Evolux can recommend additions."],
