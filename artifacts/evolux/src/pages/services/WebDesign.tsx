...
const PACKAGES = [
  ...
  },
  {
    ...
    tagline: "A dedicated creative partner for long-term growth.",
    price: "£1,200",
    note: "Per month",
    features: [
...
const FAQS = [
  ...
  },
  {
    ...
    a: "Every package includes a post-launch support window (14 or 30 days depending on your package). During that window, any issues are fixed at no charge. After that, ongoing support is available via a retainer or on an ad hoc basis.",
  },
  {
