...
const PROJECTS = [
  {
    ...
    year: "2024",
    result: "200+ brands",
    resultLabel: "fashion brands reached",
    desc: "A premium B2B trade website for a labels, trims and packaging supplier — built to win brand partnerships and showcase their portfolio to fashion's biggest names.",
  ...
  },
  {
    ...
    year: "2025",
    result: "10×",
    resultLabel: "enquiry growth",
    desc: "A conversion-focused website for a VA agency that had grown beyond its old identity — designed to reflect the scale of a growing team and attract higher-value clients.",
    image: vaMockup,
    href: null,
  },
];
