...
const POINTS = [
  "Scored against 20 conversion factors",
  "Personalised video breakdown — in your inbox within 48 hours",
...
export function LeadMagnet() {
  ...
  return (
    <section id="review" className="relative py-28 px-6 md:px-10 bg-foreground text-primary-foreground overflow-hidden">
      ...
      {/* Decorative rings */}
      <svg aria-hidden className="absolute -top-20 -right-20 w-[520px] h-[520px] pointer-events-none select-none opacity-[0.07]" viewBox="0 0 520 520" fill="none">
      ...
      <svg aria-hidden className="absolute -bottom-16 -left-16 w-[320px] h-[320px] pointer-events-none select-none opacity-[0.04]" viewBox="0 0 320 320" fill="none">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          ...
          <div>
            <motion.div
              ...
              viewport={{ once: true }}
              className="flex items-center gap-2 type-label text-white/40 mb-7"
            >
            ...
            >
              Is your website winning or losing you business{" "}
            ...
            <motion.p
              ...
              className="type-body-lg text-white/55 leading-relaxed mb-10"
            >
              Most websites have 3–5 gaps that stop visitors making contact. Submit yours and Joe will send back a personalised video review within 48 hours.
            </motion.p>
            ...
            >
              {POINTS.map(p => (
                <li key={p} className="flex items-center gap-3">
                  ...
                  <span className="type-body text-white/65">{p}</span>
                </li>
              ))}
            </motion.ul>
            ...
            >
              <Link
                href="/free-review"
                className="inline-flex items-center gap-2 text-sm font-semibold text-white/40 hover:text-white/70 border-b border-white/15 hover:border-white/40 pb-px transition-colors"
              >
                Learn more about what's included <ArrowUpRight size={12} />
              </Link>
            </motion.div>
          </div>
            ...
            {submitted ? (
              <div className="bg-white/5 border border-white/10 rounded-2xl p-10 text-center backdrop-blur-sm">
                ...
                <p className="type-body text-white/60 mb-2">
                  Joe will have your personalised website review in your inbox within 48 hours.
                </p>
              ...
              <div className="bg-white/[0.05] border border-white/10 rounded-2xl p-8 md:p-10 backdrop-blur-sm">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  ...
                  <div>
                    <label className="type-label text-white/40 mb-2 block">
