  ...
  return (
    <section className="relative flex flex-col pt-[60px] bg-background">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12">
          ...
          >
            <p className="type-body-lg text-muted-foreground leading-relaxed mb-8">
              We build websites that close deals while you sleep — combining considered design, fast code, and conversion strategy for companies that mean business.
            </p>
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-5 lg:justify-end text-sm font-semibold text-foreground/40 tracking-tight">
              <span>Relink</span>
              <span>Wavemark</span>
              <span>Huxley</span>
              <span>Stratum</span>
      ...
      >
        ...
        <div className="relative z-10 flex items-end justify-between px-6 md:px-10 pt-12 pb-8 min-h-[48vh] md:min-h-[55vh]">
          ...
          <div className="hidden md:flex flex-col items-end gap-1">
            <span className="type-label text-white/30">Next availability</span>
